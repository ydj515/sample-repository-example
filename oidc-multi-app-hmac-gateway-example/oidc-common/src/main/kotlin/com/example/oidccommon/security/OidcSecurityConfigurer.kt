...
class OidcSecurityConfigurer(
    ...
    private val gatewaySignatureValidationFilter: GatewaySignatureValidationFilter,
    ...
    fun build(http: HttpSecurity): SecurityFilterChain {
        http
            ...
            .addFilterAfter(gatewaySignatureValidationFilter, SecurityContextHolderFilter::class.java)
            .addFilterAfter(sessionAppTaggingFilter, GatewaySignatureValidationFilter::class.java)
