...
@SpringBootTest(
    properties = [
        ...
        "app.security.end-session-uri=http://localhost:9000/realms/agency-a/protocol/openid-connect/logout",
        "app.security.identity-provider-hint=platform-broker",
        "app.security.broker-logout.end-session-uri=http://localhost:9000/realms/platform-broker/protocol/openid-connect/logout",
        "app.security.broker-logout.client-id=platform-broker-logout",
