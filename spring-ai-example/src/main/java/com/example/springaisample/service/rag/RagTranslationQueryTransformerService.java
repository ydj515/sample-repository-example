...
@Service
@Slf4j
public class RagTranslationQueryTransformerService {

    private final Advisor retrievalAugmentationAdvisor;
    private final ChatClient chatClient;

    public RagTranslationQueryTransformerService(ChatClient.Builder chatClientBuilder, VectorStore vectorStore) {
