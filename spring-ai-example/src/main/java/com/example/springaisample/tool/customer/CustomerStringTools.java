...
public class CustomerStringTools {
    ...
    @Tool(description = "특정 ID의 사용자의 정보를 조회. ", returnDirect = true, resultConverter = CustomerToolResultConverter.class)
    ...
    @Tool(description = "모든 또는 전체 사용자 정보를 조회. ", returnDirect = true, resultConverter = CustomerToolResultConverter.class)
